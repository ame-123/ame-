...
class EvalRunner:
    ...
    def run(self, case_id: str | None = None) -> EvalRunResponse:
        ...
        save_eval_run(report, requested_case_id=case_id)
        return report
    ...
    def _summary(results: list[EvalCaseResult]) -> dict[str, Any]:
        ...
        return {
            ...
            "boundary": "规则化离线评测用于本项目回归，不等同于线上监控、人工抽检或 LLM-as-judge 平台。",
        }
